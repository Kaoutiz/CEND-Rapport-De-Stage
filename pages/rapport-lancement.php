...
<head>
    ...
    <div id="cookie-cover">
        ...
        <section id="rapport-lancement">
            <h1><i class='bx bx-rocket icon-title'></i><span>Rapport de lancement</span></h1>
            ...
            <p><span class="crucial">Java</span> est le langage de programmation natif pour Android, et c'est un excellent choix. Cependant, <span class="crucial">Kotlin</span> est également une bonne alternative car il est devenu le langage officiel pour les applications Android. De plus, Kotlin peut être traduit en Java par le compilateur, ce qui signifie qu'il s'agit essentiellement de Java mais avec une syntaxe plus simple. Par ailleurs, j'ai de bonnes bases en Kotlin.</p>
            <p><span class="crucial">Flutter</span> est un Framework open-source développé par <span class="crucial">Google</span> qui permet de créer des applications cross-plateform (Android / IOS). Il utilise le langage de programmation Dart, également créé par Google. En revanche, <span class="crucial">React-Native</span> est un Framework <span class="crucial">JavaScript</span> utilisant la bibliothèque <span class="crucial">React</span> développée par <span class="crucial">Facebook</span>, qui permet également le développement d'applications cross-plateform (Android / IOS).</p>
            <p>Pour les besoins du projet, nous pouvons déjà éliminer Java et Kotlin car ils nécessiteront de coder l'application deux fois dans le futur pour la rendre également disponible sur IOS. Le choix se dirige donc entre Flutter et React-Native. De plus en plus utilisé, React-Native dispose de nombreuses bibliothèques, dont une qui répond exactement à nos besoins, à savoir la numérisation de documents <a href="https://www.npmjs.com/package/react-native-document-scanner-plugin" target="_blank" class="crucial">(React-Native-document-scanner-plugin<i class='bx bx-link-external'></i>)</a>. React-Native utilise <span class="crucial">JavaScript</span>, ce qui signifie qu'il n'est pas nécessaire d'apprendre un nouveau langage. De plus, il permet une plateforme croisée sur les applications web en plus d'Android et IOS grâce à la bibliothèque React. Nous choisirons donc cette technologie.</p>
            <p>Il convient de noter que React-Native ne gère pas nativement les SVG, mais nous savons déjà que nous en aurons besoin car le graphiste de l'équipe m'a envoyé des maquettes et des assets qui sont au format SVG. Ce format est très important car il permet d'éviter la pixélisation lors de l'affichage des éléments. Heureusement, il existe une bibliothèque <a href="https://github.com/software-mansion/react-native-svg" target="_blank" class="crucial">(React-Native-svg<i class='bx bx-link-external'></i>)</a> qui me permettra de gérer les SVG dans l'application React-Native. En ce qui concerne les besoins de fluidité, la bibliothèque <a href="https://github.com/software-mansion/react-native-screens" target="_blank" class="crucial">React-Native-screens<i class='bx bx-link-external'></i></a> améliorera la fluidité de navigation.</p>
            <h2>Conclusion :</h2>
            <p>En conclusion, le projet <span class="crucial">CEND</span> est une évolution du projet <span class="crucial">CloudPix</span> développé l'année dernière. Le but de ce projet est d'ajouter une fonctionnalité permettant de scanner des documents tels que des factures d'achat et des notes de frais pour les envoyer directement sur le CloudPix du client dans la section adéquate.</p>
